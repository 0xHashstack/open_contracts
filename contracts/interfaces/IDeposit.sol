...
interface IDeposit {
	...
	function withdrawDeposit (bytes32 _market, bytes32 _commitment,uint _amount) external returns (bool);
	function depositRequest(bytes32 _market, bytes32 _commitment, uint _amount) external returns(bool success);
